...
class StoryList {
  ...
  async addStory(user, newStory) {
    //make a POST request to the url to create a new story based on the newStory parameter we pass in
    const response = await axios({
      url: `${BASE_URL}/stories`,
      method: "POST",
      data: {
    ...
    //create a new instance of the Story class with the data we retreive from the API and return the new instance
